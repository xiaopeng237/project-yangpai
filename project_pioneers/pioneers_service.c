...
void function_dd_set_pulse_spectrum(int* pPulseData, enum PulseSpectrum Switch);
void function_dd_set_energy_spectrum(unsigned int* pEnergyS, enum EnergySpectrum Switch);
/*******************************************************************************
* 函数名称:function_web_spectral_data_write
* 函数功能:生成能谱文件 供网页使用
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
/*******************************************************************************
* 函数名称: function_dd_set_sw_time
* 函数功能: 从rtc获取系统时间设置到sw中
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
* 
...
/*******************************************************************************
* 函数名称: function_dd_get_spi_win_from_fpga
* 函数功能: 获取FPGA窗口数据
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
* 
*******************************************************************************/
void function_dd_get_spi_win_from_fpga()
{
...
/*******************************************************************************
* 函数名称: function_mysql_assignment
* 函数功能: 数据对外输出显示填充
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
* 
*******************************************************************************/
void function_mysql_assignment()
{
    T_DateTime DataTime;
    T_RtuData RtuData;
...
/*******************************************************************************
* 函数名称:function_calculate_flow_main
* 函数功能:流量计算主函数
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
* 
*******************************************************************************/
void function_calculate_flow_main()
{
    function_calculate_para_init();
    if(tArm_Mysql.t_Arm_Set.Arm_Set_board_type)
    {//todo：预留
    }
    function_calculate_flow_start();
    function_calculate_para_result_check();
    function_mysql_assignment();
}

/*******************************************************************************
* 函数名称: function_dd_get_spi_pull_from_fpga
* 函数功能: 获取脉冲数据
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
/*******************************************************************************
* 函数名称: function_dd_get_spi_energy_from_fpga
* 函数功能: 获取能谱数据
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
/*******************************************************************************
* 函数名称: function_web_flow_data_table_write
* 函数功能: 生成流量json文件
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
* 
*******************************************************************************/
int function_web_flow_data_table_write(double fgas, double foil, double tem1, double pre)
{
    ...
    int i;
    static long int timestamps[1440];
    static double fgass[4];
    static double tem1s[4];
    static double foils[4];
    static double pres[4];
    
    function_dd_get_sw_time(&DataTime);
    for(i=0; i < (4 - 1); i++)
    {
        fgass[(4 - 1)-i] = fgass[(4 - 2)-i];
        foils[(4 - 1)-i] = foils[(4 - 2)-i];
        tem1s[(4 - 1)-i] = tem1s[(4 - 2)-i];
        pres[(4 - 1)-i] = pres[(4 - 2)-i];
...
int function_msql_to_apache(void)
{
    ...
    if(math_C<60)//（）每秒数据(五个窗口计数；温度；压力；差压)计算200次，数据结果累加输出
    {
        ...
        if(math_C==60)//每分钟数据；数据存入mysql；生成流量表格.json；生成曲线文件；
        {
            ...
            function_web_flow_data_table_write(FlowParass.Qvl_CPM, FlowParass.Qvg_CPM, FlowParass.T_P_WC_CPS, FlowParass.P_WC_CPM);
