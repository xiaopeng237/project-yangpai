...
double g_qml_add = 0;
/*******************************************************************************
* 函数名称:function_calculate_para_init
...
* 
*******************************************************************************/
void function_calculate_para_init()
{
    T_DateTime DataTime;
...
#define HLP 10.54
/*******************************************************************************
* 函数名称:function_calculate_flow_start
...
* 
*******************************************************************************/
void function_calculate_flow_start()
{
    /*仅开机读取一次的量，理论上为非变量*/
...
/*******************************************************************************
* 函数名称:function_calculate_para_result_check
* 函数功能:完成数据合理性检查
* 相关文档:
* 函数参数:
* 参数名称:         类型      输入/输出     描述
...
* 
*******************************************************************************/
void function_calculate_para_result_check()
{
    int ret;
